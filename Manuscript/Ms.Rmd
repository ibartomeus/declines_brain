...
Keywords: encephalisation, brain-body mass ratio, habitat preference, Apoidea, GBIF
...
p <- ggtree(bee.tree100) %<+% brain_weight  +  aes(color=Country)+
    ...
    theme_tree2()+scale_size_continuous(range = c(-1, 3.6),name="Encephalisation")+
...
labels.minor <- c("Avoidance", "", "Preference")
...
```{r, echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE,fig.align="center", fig.height=6, fig.width=7, fig.cap="\\textbf{Figure S1.}", fig.pos="p", out.width="80%"}
...
```{r, echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE,fig.align="center", fig.height=6, fig.width=7, fig.cap="\\textbf{Figure S2.}", fig.pos="p", out.width="100%"}
