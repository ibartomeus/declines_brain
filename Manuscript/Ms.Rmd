...
\textbf{Miguel Á. Collado$^{1}$} \orcidlink{0000-0002-4216-317X} \textbf{Jose B. Lanuza$^{2}$} \orcidlink{0000-0002-0287-409X} \textbf{Ferran Sayol$^{3}$} \orcidlink{0000-0003-3540-7487} \textbf{and Ignasi Bartomeus$^{2}$} \orcidlink{0000-0001-7893-4389}
...
Centre de Recerca Ecològica i Aplicacions Forestals: Bellaterra, Catalonia, Spain
...
https://www.biorxiv.org/content/10.1101/2022.12.09.519739v1
...
For the `r nlevels(factor(unique(d$Species)))` bee species, brain size scaled allometrically with body size (Bayesian R$^2$ = `r r2`). However, there were considerable variability in brain size relative to the body across species (Figure S1). Considering this association, the species with the largest and smallest brains relative to the body were the American bee *`r largest_encephalisation`* and the European bee *`r lowest_encephalisation`*, respectively.

Mention how this is constrained by phylogenetic relationship but there is still large variability.
