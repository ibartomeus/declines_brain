...
```{r Plotting Europe, eval = TRUE, fig.align = 'center', echo = FALSE, warning = FALSE, message = FALSE, fig.height=8, fig.width=6}
...
Now we make more strict land use classifications
...
And we model the data with this categories:


```{r Plotting Europe subset, eval = TRUE, fig.align = 'center', echo = FALSE, warning = FALSE, message = FALSE, fig.height=8, fig.width=6}
...
library(patchwork)
p1 + p2 + p3 + plot_layout(ncol = 1) + plot_layout(guides = "collect")
...
United States land use classification with total number of occurrences within cover type in our dataset
...
```{r Plotting USA, eval = TRUE, fig.align = 'center', echo = FALSE, warning = FALSE, message = FALSE, fig.height=8, fig.width=6}
...
Now we make more strict categories of what is Natural, Urban and Agricultural. See below:
...
```{r Plotting USA subset, eval = TRUE, fig.align = 'center', echo = FALSE, warning = FALSE, message = FALSE, fig.height=8, fig.width=6}
