...
#Load preferences
preferences = read_csv("Data/Europe_data/preferences_europe.csv") 
...
write_csv(long_data , "Data/Europe_data/data_preference_residuals_europe.csv")
write_csv(ce1[[1]], "Data/Europe_data/model_output_preference_residuals_europe.csv")
...
#Save data
write_csv(ce2[[1]], "Data/Europe_data/model_output_preference_brain_weight_europe.csv")
...
#Save data
write_csv(ce3[[1]], "Data/Europe_data/model_output_preference_it_europe.csv")
