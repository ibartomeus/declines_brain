...
#Load preferences
preferences_europe = read_csv("Data/Europe_data/preferences_europe_qualitative_subset.csv") 
preferences_usa = read_csv("Data/Usa_data/preferences_usa_qualitative_subset.csv") 
#merge datasets
...
write_csv(long_data , "Data/Europe_USA/data_preference_residuals_europe_usa_subset_qualitative.csv")
write_csv(ce1[[1]], "Data/Europe_USA/model_output_preference_residuals_europe_usa_subset_qualitative.csv")
...
#Save data
write_csv(ce2[[1]], "Data/Europe_USA/model_output_preference_brain_weight_europe_usa_subset_qualitative.csv")
...
#Save data
write_csv(ce3[[1]], "Data/Europe_USA/model_output_preference_it_europe_usa_subset_qualitative.csv")
...
#Save data
write_csv(ce4[[1]], "Data/Europe_USA/model_output_preference_brain_it_europe_usa_subset_qualitative.csv")
