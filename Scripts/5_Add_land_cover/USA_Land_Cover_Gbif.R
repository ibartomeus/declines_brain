...
#Load data
usa <- read.table("Data/Usa_data/all_above_50_usa_gbif.csv.gz",  header=T, quote="\"", sep=",")
...
extract_cover <- function(year,
                          point_d = "Data/Usa_data/all_above_50_usa_gbif.csv.gz",  
...
extract_cover(year = 2011, point_d = "Data/Usa_data/all_above_50_usa_gbif.csv.gz", write_dir = "Data/Usa_data")
