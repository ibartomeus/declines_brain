...
write_csv(m, "Data/Usa_data/preferences_usa_qualitative_gbif.csv")
...
#Load preferences
preferences = read_csv("Data/Usa_data/preferences_usa_qualitative_gbif.csv") 
...
write_csv(long_data , "Data/Usa_data/data_preference_residuals_usa_qualitative_gbif.csv")
write_csv(ce1[[1]], "Data/Usa_data/model_output_preference_residuals_usa_qualitative_gbif.csv")
...
#Save data
write_csv(ce2[[1]], "Data/Usa_data/model_output_preference_brain_weight_usa_qualitative_gbif.csv")
...
#Save data
write_csv(ce3[[1]], "Data/Usa_data/model_output_preference_it_usa_qualitative_gbif.csv")
...
#Save data
write_csv(ce4[[1]], "Data/Usa_data/model_output_preference_brain_it_usa_qualitative_gbif.csv")
