...
write_csv(ce1[[1]], "Data/Europe_USA/model_output_preference_residuals_europe_usa_qualitative.csv")
...
#Save data
write_csv(ce2[[1]], "Data/Europe_USA/model_output_preference_brain_weight_europe_usa_qualitative.csv")
...
#Save data
write_csv(ce3[[1]], "Data/Europe_USA/model_output_preference_it_europe_usa_qualitative.csv")
...
#Save data
write_csv(ce4[[1]], "Data/Europe_USA/model_output_preference_brain_it_europe_usa_qualitative.csv")
